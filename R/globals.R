...
n_pops      =   10,    # number of populations to spawn ----
n_ind       =  50,    # number of individuals to be placed ----
...
steps       = 200          # steps for the genetic simulation
)
